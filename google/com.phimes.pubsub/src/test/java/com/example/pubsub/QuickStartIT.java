...
import com.phimes.pubsub.util.CreatePullSubscription;
import com.phimes.pubsub.util.CreateTopic;
...
public class QuickStartIT {
  ...
  class SubscriberRunnable implements Runnable {
    ...
    public void run() {
      try {
        //SubscribeMessage.main(subscriptionId);
      } catch (Exception e) {
        e.printStackTrace();
      }
    }
  ...
  public void testQuickstart() throws Exception {
    ...
    bout.reset();
    // publish messages
    //PublisherMessage.main(topicId, String.valueOf(messageCount));
