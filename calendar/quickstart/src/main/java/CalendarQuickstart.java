...
public class CalendarQuickstart {
	...
	public static void main(String... args) throws IOException, GeneralSecurityException {
		...
		Event event = new Event().setSummary("BisericaMaranata").setLocation("via modena, 44, Alessandria, Italy")
				.setDescription("Revelion2018");

		DateTime startDateTime = new DateTime("2018-12-31T22:00:00");
		EventDateTime start = new EventDateTime().setDateTime(startDateTime).setTimeZone("Europe/Rome");
		event.setStart(start);

		DateTime endDateTime = new DateTime("2018-12-31T23:00:00");
		...
		service.events().delete("primary", "event").execute();
